...
STEP_ONE_INTERMEDIATE_RESULTS = join(INTERMEDIATE_DIRECTORY, "step_1")
SIM_MODELS = join(INTERMEDIATE_DIRECTORY, "models")
LEGAL_SBERT_NLI_MODEL = join(SIM_MODELS, "legal_sbert_nli_model")